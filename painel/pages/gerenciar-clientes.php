<div class="box-content">
	<h2><i class="fa-solid fa-file-pen"></i> Clintes Cadastrados</h2>
    <div class="busca">
	...
	<div class="boxes">
      ...
      <div class="box-single-wraper">
         ...
         <div class="body-box">
             ...
             <div class="group-btn">
            <a  class="btn delete"  item_id="<?php echo $value['id']; ?>" href="<?php echo INCLUDE_PATH_PAINEL ?>">
                <i class="fa-solid fa-circle-xmark"></i> Excluir</a>
