...
<div class="box-content">
	<h2><i class="fa-solid fa-pencil"></i> Editar Cliente</h2>
    ...
    <div class="form-group">
      ...
      <select name="tipo_cliente">
            ...
            <option <?php if($cliente['tipo'] == 'juridico') echo 'selected'?> value="juridico">Juridico</option>
            </select>
    </div><!--form-group-->
    <?php
    ...
    <?php }else{ ?>
      ...
      <div class="form-group">
			<label>Imagem:</label>
			<input type="file" name="imagem" value="<?php echo $cliente['imagem']; ?>" />
		</div><!--form-group-->
        <div class="form-group">
